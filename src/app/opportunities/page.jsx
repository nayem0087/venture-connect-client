...
const OpportunitiesViewPage = () => {
    ...
    // Fetch which opportunities this user has already bookmarked, so hearts render filled correctly.
    useEffect(() => {
            ...
            try {
                ...
                if (data.success) {
                    const ids = data.bookmarks
                        .filter((b) => b.itemType === 'opportunity')
                        .map((b) => b.itemId);
                                ...
                                >
                                    ...
                                    <div className="absolute top-5 right-5">
                                        <BookmarkButton
                                            ...
                                            initialBookmarked={bookmarkedIds.has(oppId)}
                                        />
                                    </div>

                                    <h2 className="text-2xl font-bold mb-2 pr-10 group-hover:text-purple-400 transition-colors line-clamp-1">
                                        {opp.title}
                                    </h2>
